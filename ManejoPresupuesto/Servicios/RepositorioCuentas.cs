...
namespace ManejoPresupuesto.Servicios
{
    ...
    public class RepositorioCuentas: IRepositorioCuentas
    {
        ...
        {
            //se inserta y se obtiene el id del elemento recien creado
        ...
        {
            using var conmection = new SqlConnection(connectionString);
            return await conmection.QueryAsync<Cuenta>(@"SELECT Cuentas.Id, Cuentas.Nombre, Balance, tc.Nombre AS TipoCuenta
